...
<script>
    $(function () {
        ...
        $("#userList").jqGrid({
            ...
            autowidth:true,
            height:400,
            url:"${pageContext.request.contextPath}/user/findAll",//这是请求url
            datatype:"json",//设置响应结果为json格式
            colNames:['ID','Name',"Photo","Sex","Register_date","Last_login","Status"],//指定表格标题
            colModel:[  //用来指定json中那个key作为该列的值
                {name:"id",search: false,align:"center"},//这是列属性对象配置信息
                {name:"name",editable:true,align:"center",editoptions:{required:true}},
                {name:"photo",editable:true,align:"center",edittype:"file",
                    formatter:function(value,options,row){
                        return "<img src='"+value+"' style='width:100%'/>";
                    },editoptions:{enctype:"multipart/form-data"}
                },
                {name:"sex",editable:true,align:"center",editoptions:{required:true}},
                {name:"register_date",editable:true,align:"center",editoptions:{required:true}},
                {name:"last_login",editable:true,align:"center",editoptions:{required:true}},
            ...
            editurl:'${pageContext.request.contextPath}/user/edit',//执行编辑时请求url  (添加 oper:add 删除 del  更新 edit)
            caption:"用户列表",//指定表格标题
            ...
            // edit add del
            {
                ...
                beforeShowForm:function (frm) {
                    frm.find("#register_date").attr("disabled",true);
                },
            },{
                closeAfterAdd:true,
